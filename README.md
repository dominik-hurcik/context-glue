...
In some teams, we can often work across several repos, which was often the case for my personal experience. Maybe a pipeline repo, an orchestration layer, a data warehouse, a handful of extractors. Each one has its own conventions, its own quirks, its own history of decisions.
